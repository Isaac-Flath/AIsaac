...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'isaacai.dataloaders': { 'isaacai.dataloaders.DataLoaders': ('dataloaders.html#dataloaders', 'isaacai/dataloaders.py'),
            ...
            'isaacai.tracking': { 'isaacai.tracking.TrackingCB': ('tracking.html#trackingcb', 'isaacai/tracking.py'),
                                  ...
                                  'isaacai.tracking.TrackingCB.after_fit': ('tracking.html#trackingcb.after_fit', 'isaacai/tracking.py'),
                                  'isaacai.tracking.TrackingCB.before_fit': ('tracking.html#trackingcb.before_fit', 'isaacai/tracking.py'),
                                  'isaacai.tracking.sql_connect': ('tracking.html#sql_connect', 'isaacai/tracking.py')},
